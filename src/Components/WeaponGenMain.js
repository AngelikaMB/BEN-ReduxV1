...
return(
    ...
    Kindred = Roll on the brand table again, anything but Kindred. Do not display the name, but pull the modifiers except price which should remain as Kindred. */}
            ...
            <WeaponBody>
                ...
                : <p>Damage: {dieNum(props.weapon.numOfDie, props.brand.dieNumMod)}d{dieSize(props.weapon.dieSize, props.brand.dieSizeMod, props.brand.dieSizeModNum)} {props.weapon.damageType}</p>}
                {props.weapon.conversionNumOfDie ? 
                <p>{props.weapon.conversion} {conversionDieNum(props.weapon.conversionNumOfDie, props.brand.dieNumMod)}d{conversionDieSize(props.weapon.conversionDieSize, props.brand.dieSizeMod, props.brand.dieSizeModNum)} {props.weapon.damageType} </p>
                : ''}
